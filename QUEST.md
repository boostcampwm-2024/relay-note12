...
1. 주말에 맛있는 거 먹으러 외출하기. 
    ...
    수행 기준 : 인증샷 (음식사진, 영수증..?)
    > 
2. 일주일동안 잘 해결한 일 한가지를 적어보기.
    
    ![image](https://github.com/user-attachments/assets/0734d050-ad60-4447-bd85-cb95f680820b)

    > 수행 기준:  일주일동안 잘 해결한 일 한가지 기록으로 남기기. 
    기존 퀘스트 : 오늘 하루 잘 해결한 일 한가지를 적어보기
    변경한 이유 :  오늘 하루면 하루 한개씩인데 너무 많습니다. 일주일에 한개로 변경하겠습니다.
    > 
3. 4주차 매칭되는 짝의 스트레스 및 컨디션 관리 비법을 진행해보고 기록 남기기
    
    ![image](https://github.com/user-attachments/assets/c2bf46d4-5aa9-4f59-9a4f-ff06dbaa14a3)
    
    > 기존 퀘스트 : 다른 캠퍼의 스트레스 및 컨디션 관리 비법을 한번 시험해보기.
    > 
    > 
    > 변경한 이유 : 짝과 함께 하는 미션인 만큼 스트레스도 같이 풀어봐요 :)
    > 
    > 수행 기준 : 깃에 기록 남기기
    > 
4. 일주일 동안 살아남으며 2번 그림일기 쓰고 Slack에 업로드하기.
    
    ![image](https://github.com/user-attachments/assets/963da147-12fd-413b-88b0-9a204eda7eaa)
    
    *~~(죽지도 않고 또 온 그림일기 무새)~~*
    
    > 기존 퀘스트 : 일주일 동안 살아남으며 생존 신고 사진을 Slack 에 업로드하기.
    > 
    > 
    > 변경한 이유 : 여러분들의 하루 감상 보고 싶습니다.
    > 수행 기준 : 그림일기 써서(양식 무관) 슬랙에 올리기
    > 
5. 하루 휴식 시간표를 작성해 github 혹은 Slack 에 업로드하고 지키기.
    
    ![cdbb3f25a0d5ae6111d2daefc4b54b9e](https://github.com/user-attachments/assets/83be376d-ac5a-4083-8864-faa959924f08)

    
    > 기존 퀘스트 : 밥은 먹으면서 미션 해결하기.
    > 
    > 
    > 유지 :   휴식도 시간표에 맞춰서 하면 더 효율적으로 쉴 수 있지 않을까 생각 했습니다.
    > 
    > 수행 기준 : 시간표를 업로드하고, 짧은 후기 남기기.
    > 

6. 5~10분 정도 산책하며 생각을 비우기.

   ![bcae4c26b4e878a287c59a3503eb5e56](https://github.com/user-attachments/assets/dd31fab6-5332-4b59-bfc8-37b7a09f3f38)
    
    > 기존 퀘스트 : 5~10분 정도 산책하며 생각을 비우기.
    > 
    > 
    > 유지  : 퀘스트를 구체적으로 만들었습니다.
    > 
    > 수행 기준 : 산책을 할때 소소하게 산책 인증샷(바깥 풍경)을 slack에 올리기
    >

<details>
   <summary>이전 퀘스트 (2주차)</summary>
